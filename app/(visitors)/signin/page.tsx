              ...
              <div className="space-y-5">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    variant="outline"
                    className="w-full h-11 border-purple-400/40 bg-purple-500/5 hover:bg-purple-500/10 hover:border-purple-400/60 text-foreground transition-all duration-300 hover:shadow-md hover:shadow-purple-500/10"
                  >
                    Sign in
                  </Button>
                </form>
